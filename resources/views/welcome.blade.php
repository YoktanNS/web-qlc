...
<section class="position-relative overflow-hidden" style="min-height:90vh; display:flex; align-items:center;">
    {{-- Background Gradient --}}
    <div class="position-absolute top-0 start-0 w-100 h-100" style="background: radial-gradient(ellipse at 30% 50%, rgba(99,102,241,0.15) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(139,92,246,0.12) 0%, transparent 50%); pointer-events:none;"></div>

    <div class="container position-relative z-1">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 animate-fadeup">
                <span class="badge rounded-pill px-3 py-2 mb-4" style="background:rgba(99,102,241,0.2); color:#a5b4fc; font-size:.85rem; border:1px solid rgba(99,102,241,0.3);">
                ...
                <p class="text-muted fs-5 mb-4" style="line-height:1.7;">
                    Deteksi dini tingkat QLC-mu menggunakan metode <strong class="text-info">Forward Chaining</strong> berbasis 20 indikator ilmiah, dan dapatkan rekomendasi action plan personal terurut menggunakan <strong class="text-info">Simple Additive Weighting (SAW)</strong>.
                </p>
                ...
                <div class="row g-3 mb-5">
                    <div class="col-4">
                        <div class="card-glass p-3 text-center">
                            <div class="fs-4 fw-bold" style="color:#a5b4fc;">20</div>
                            <div class="small text-muted">Indikator QLC</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card-glass p-3 text-center">
                            <div class="fs-4 fw-bold" style="color:#67e8f9;">5</div>
                            <div class="small text-muted">Domain Gejala</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card-glass p-3 text-center">
                            <div class="fs-4 fw-bold" style="color:#6ee7b7;">12</div>
                ...
                <div class="card-glass p-4 mx-auto" style="max-width:380px;">
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="badge" style="background:rgba(245,158,11,0.2); color:#fcd34d;">QLC Sedang</span>
                        </div>
                        <div class="display-4 fw-bold" style="color:#fcd34d;">47<small class="fs-4 text-muted">/80</small></div>
                    </div>
                    {{-- Domain bars contoh --}}
                    @php
                        $demoDomains = [
                            ['name'=>'Identitas Diri',     'pct'=>75, 'color'=>'#6366f1'],
                            ['name'=>'Karir & Tujuan',     'pct'=>85, 'color'=>'#8b5cf6'],
                            ['name'=>'Finansial',          'pct'=>60, 'color'=>'#06b6d4'],
                            ['name'=>'Sosial & Relasi',    'pct'=>50, 'color'=>'#10b981'],
                            ['name'=>'Psikologis',         'pct'=>45, 'color'=>'#f59e0b'],
                        ];
                    @endphp
                    ...
                    <div class="mt-4 pt-3 border-top border-secondary">
                        ...
                        @foreach(['Journaling Klarifikasi Nilai','SMART Goals Jangka Pendek','Restrukturisasi Kognitif'] as $i => $ap)
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:26px; height:26px; background:rgba(99,102,241,0.2); color:#a5b4fc; font-size:.75rem; font-weight:700;">{{ $i+1 }}</div>
...
{{-- Cara Kerja --}}
<section class="py-5" style="background:var(--dark-2);">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            @php
                $steps = [
                    ['icon'=>'bi-clipboard-check', 'color'=>'#6366f1', 'num'=>'01', 'title'=>'Isi Kuesioner', 'desc'=>'20 pernyataan dalam 5 domain QLC. Skala Likert 1–5. Tidak ada jawaban benar/salah.'],
                    ['icon'=>'bi-cpu',             'color'=>'#8b5cf6', 'num'=>'02', 'title'=>'Forward Chaining', 'desc'=>'Mesin inferensi membandingkan jawabanmu dengan rule base untuk menentukan level QLC.'],
                    ['icon'=>'bi-bar-chart-steps', 'color'=>'#06b6d4', 'num'=>'03', 'title'=>'SAW Meranking', 'desc'=>'12 action plan diranking menggunakan 4 kriteria terbobot untuk hasil yang paling personal.'],
                ];
            @endphp
            @foreach($steps as $s)
                <div class="col-md-4">
                    <div class="card-glass p-4 h-100 text-center">
                        <div class="mb-3">
                            <div class="d-inline-flex align-items-center justify-content-center rounded-3 mb-3" style="width:64px; height:64px; background: rgba({{ $s['num']=='01'?'99,102,241':($s['num']=='02'?'139,92,246':'6,182,212') }}, 0.15);">
